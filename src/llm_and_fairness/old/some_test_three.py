...
from appl_logic.appl_controller_test_bank import ApplControllerTestBank
...
def create_system():
    ...
    appl_logic = ApplControllerTestBank(add_memory_uc, get_memories_uc, display_uc, response_handler, send_msg_uc)
    appl_logic.execute()
