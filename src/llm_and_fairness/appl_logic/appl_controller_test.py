...
class ApplControllerTest:
    ...
    def init_messages(self):
        ...
        #self.messages.append(UserMessage("Puoi eseguire la codifica del mio dataset adult? Puoi usare il tool esegui_codifica_dataset", {}))
        ...
        self.messages.append(UserMessage("Devo predire se il reddito annuo income di un soggetto sara maggiore di 50000 dollari oppure minore od uguale a 50000 dollari. Di quale problema di learning si tratta (classificazione, regressione, clustering.....)? Rispondi fornendo solo il nome del problema", {}))
        ...
        #self.messages.append(UserMessage("Puoi eseguire lo split del dataset adult_encoded in train test set usando come target income?", {}))
