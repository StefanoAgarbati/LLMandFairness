...
class ApplControllerTest:
    ...
    def init_messages(self):
        ...
        self.messages.append(UserMessage("Valuta i modelli usando il mio dataset codificato, la mia variable target, le metriche disponibili e i modelli disponibili per il mio problema di learning?Usa il tool evaluate_models", {}))
        ...
        self.messages.append(UserMessage("Puoi eseguire lo split del dataset in train test set usando come target income?", {}))
